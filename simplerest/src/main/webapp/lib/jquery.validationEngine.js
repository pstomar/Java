	 ...
	 var methods = {
		...
		*/
		_validateField: function(field, options, skipAjaxValidation) {
			...
			var newoption="";
if(hasValue(options)){
	 newoption =options.validateAttribute}
			var rulesParsing = field.attr(newoption);
		...
		*/
		...
		var fieldType1 = field.prop("type");

		if(fieldType1== "radio"){
			prompt.css({
						"opacity": 0,
						'position':'inherit',
						'margin-left':'-200px','width':'153px'
					});}
		else{
	prompt.css({
				"opacity": 0,
		...
		*/
		_updatePrompt: function(field, prompt, promptText, type, ajaxed, options, noAnimation) {
			...
			if (prompt) {
				...
				else{ css = {"top": pos.callerTopPosition,
								"left": pos.callerleftPosition,
								"marginTop": pos.marginTopSize};}
